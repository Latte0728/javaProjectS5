    	...
    	$.ajax({
    		...
    		success:function(res){
    			if(res == "1") {
	    			...
	    			else location.href = "${ctp}/sign/signUpdate";
    			}
    			else {
			...
			<table class="table table-borderless text-center">
			  <tr>
			    <td>
			      ...
			      <input type="button" value="돌아가기" onclick="location.href='${ctp}/sign/signMain';" class="btn btn-warning" />
			    </td>
			  </tr>
		  </table>
		    ...
		    <tr>
		      <td colspan="2">
		        <div class="row">
			        ...
			        <div class="col"><input type="button" value="돌아가기" onclick="location.href='${ctp}/sign/signPwdCheck/p';" class=" btn btn-secondary form-control"/></div>
		        </div>
		      </td>
		    </tr>
		  </table>
