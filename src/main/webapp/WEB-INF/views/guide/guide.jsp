...
<div class="container">
	<h2 id="guide1">도감</h2>
	<p><br/></p>
	<h3 id="gName1"><i class="fa fa-twitter fa-2x" aria-hidden="true" id="pic1"></i>${vo.name}</h3>
	<form class="guideForm1">
	...
	<span id="sp">새들이 어떻게 생활을 하고 어떤 먹이를 어떻게 사냥해 먹는지, 그리고 한국에서 살아가는 이 새들의 특징은 무엇인이 알아 볼 수 있습니다.</span>
		...
		<div>
			<span style="display: inline-block; margin-left: 200px;">
				<input type="submit" onclick="location.href='/h';" value="top" class="btn1 btn btn-info form-control" style="width:100%" />
			</span>
			...
			<span style="display: inline-block; margin-left: 100px;">
				<input type="button" onclick="" value="이전화면으로 돌아가기" class="btn1 btn-danger form-control" style="width:100%"  />
			</span> 
		</div>
	</form>		
</div>  
